Contributing to hbcur Core
============================

The hbcur Core project operates an open contributor model where anyone is
...
The following applies to code changes to the hbcur Core project, and is not to be
confused with overall hbcur Network Protocol consensus changes.

Whether a pull request is merged into hbcur Core rests with the project merge
...
Patches that change hbcur consensus rules are considerably more involved than
...
Where a patch set proposes to change the hbcur consensus, it must have been
...
The project leader is the release manager for each hbcur Core release.
