Contributing to hbcucoin Core
============================

The hbcucoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the hbcucoin Core project, and is not to be
confused with overall hbcucoin Network Protocol consensus changes.

Whether a pull request is merged into hbcucoin Core rests with the project merge
...
Patches that change hbcucoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the hbcucoin consensus, it must have been
...
The project leader is the release manager for each hbcucoin Core release.
