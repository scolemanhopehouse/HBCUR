...
RESOURCES += src/qt/hbcur.qrc src/qt/hbcur_locale.qrc

TRANSLATIONS += src/qt/locale/hbcur_bg.ts \
                src/qt/locale/hbcur_de.ts \
                src/qt/locale/hbcur_en.ts \
                src/qt/locale/hbcur_es.ts \
                src/qt/locale/hbcur_fi.ts \
                src/qt/locale/hbcur_fr.ts \
                src/qt/locale/hbcur_it.ts \
                src/qt/locale/hbcur_ja.ts \
                src/qt/locale/hbcur_pl.ts \
                src/qt/locale/hbcur_pt.ts \
                src/qt/locale/hbcur_ru.ts \
                src/qt/locale/hbcur_sk.ts \
                src/qt/locale/hbcur_sv.ts \
                src/qt/locale/hbcur_vi.ts \
                src/qt/locale/hbcur_zh_CN.ts \
                src/qt/locale/hbcur_zh_TW.ts
