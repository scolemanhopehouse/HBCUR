...
This means one can have an always-on hbcurd instance running, and another local hbcurd/hbcur-qt instance which connects to this node and receives blocks from it.
