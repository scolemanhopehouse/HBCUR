...
In order to support loading of multiple wallets in hbcucoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hbcucoin.cpp.
...
Changes to hbcucoin.cpp
----------------------
hbcucoin.cpp is the entry point into hbcucoin-qt, and as such, will require some minor modifications to provide hooks for
