...
In order to support loading of multiple wallets in hbcur-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hbcur.cpp.
...
Changes to hbcur.cpp
----------------------
hbcur.cpp is the entry point into hbcur-qt, and as such, will require some minor modifications to provide hooks for
