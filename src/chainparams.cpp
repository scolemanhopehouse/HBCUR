...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 300; // 300 seconds
        nMaturity = 10;
        ...
        const char* pszTimestamp = "HISTORICALLY BLACK UNIVERSITY COIN";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1616451515;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 4343802;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x9b15f32d960007879f914b245fca25b09708f8b07d9f2c584698a49ecd013f9c"));
        assert(hashGenesisBlock == uint256("0x00000b386cdcfb0c6f7225e37985c2ddbc709ca9ccb975d8896405cc3d4f434d"));

     
		
	vSeeds.push_back(CDNSSeedData("1", "143.198.77.113"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x9b15f32d960007879f914b245fca25b09708f8b07d9f2c584698a49ecd013f9c"));
        assert(hashGenesisBlock == uint256("0x00001761f2deb10ecd581a0e5e0a1e926f83b7ac570aac65814f6d00855bcbfa"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x9b15f32d960007879f914b245fca25b09708f8b07d9f2c584698a49ecd013f9c"));
        assert(hashGenesisBlock == uint256("0x19c3df6380bd14c727a7620dbcfd395339f71b1152f0a116e665a7897e5f975c"));
