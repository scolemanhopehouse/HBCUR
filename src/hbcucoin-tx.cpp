...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("hbcucoin hbcucoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hbcucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hbcucoin transaction") + "\n" +
                               "  hbcucoin-tx [options] -create [commands]   " + _("Create hex-encoded hbcucoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hbcucoin transaction
