...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("hbcur Core hbcur-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hbcur-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hbcur transaction") + "\n" +
                               "  hbcur-tx [options] -create [commands]   " + _("Create hex-encoded hbcur transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hbcur transaction
