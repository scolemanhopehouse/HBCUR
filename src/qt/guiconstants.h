...
/* hbcucoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "hbcucoin"
#define QAPP_ORG_DOMAIN "hbcucoinproject.org"
#define QAPP_APP_NAME_DEFAULT "hbcucoin-Qt"
#define QAPP_APP_NAME_TESTNET "hbcucoin-Qt-testnet"
