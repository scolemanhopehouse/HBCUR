...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("hbcucoin Core"),
     ...
     * override -datadir in the hbcucoin.conf file in the default data directory
     * (to be consistent with hbcucoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
