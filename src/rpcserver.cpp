...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop hbcucoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "hbcucoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* hbcucoin features */
        {"hbcucoin", "masternode", &masternode, true, true, false},
        {"hbcucoin", "listmasternodes", &listmasternodes, true, true, false},
        {"hbcucoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hbcucoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hbcucoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"hbcucoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"hbcucoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"hbcucoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hbcucoin", "masternodedebug", &masternodedebug, true, true, false},
        {"hbcucoin", "startmasternode", &startmasternode, true, true, false},
        {"hbcucoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hbcucoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hbcucoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hbcucoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hbcucoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hbcucoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hbcucoin", "mnbudget", &mnbudget, true, true, false},
        {"hbcucoin", "preparebudget", &preparebudget, true, true, false},
        {"hbcucoin", "submitbudget", &submitbudget, true, true, false},
        {"hbcucoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hbcucoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hbcucoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hbcucoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hbcucoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hbcucoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hbcucoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hbcucoin", "checkbudgets", &checkbudgets, true, true, false},
        {"hbcucoin", "mnsync", &mnsync, true, true, false},
        {"hbcucoin", "spork", &spork, true, true, false},
        {"hbcucoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> hbcucoin-cli " + methodname + " " + args + "\n";
}
