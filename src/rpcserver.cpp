...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"hbcur", "masternode", &masternode, true, true, false},
        {"hbcur", "listmasternodes", &listmasternodes, true, true, false},
        {"hbcur", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hbcur", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hbcur", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hbcur", "masternodedebug", &masternodedebug, true, true, false},
        {"hbcur", "startmasternode", &startmasternode, true, true, false},
        {"hbcur", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hbcur", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hbcur", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hbcur", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hbcur", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hbcur", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hbcur", "mnbudget", &mnbudget, true, true, false},
        {"hbcur", "preparebudget", &preparebudget, true, true, false},
        {"hbcur", "submitbudget", &submitbudget, true, true, false},
        {"hbcur", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hbcur", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hbcur", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hbcur", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hbcur", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hbcur", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hbcur", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hbcur", "checkbudgets", &checkbudgets, true, true, false},
        {"hbcur", "mnsync", &mnsync, true, true, false},
        {"hbcur", "spork", &spork, true, true, false},
        {"hbcur", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hbcur", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hbcurd, or the -server option to hbcur-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hbcur-cli " + methodname + " " + args + "\n";
}
